/*eslint-env node*/
/*eslint quotes:0, no-unused-vars:[2], camelcase:0 */
...
test('Error output should match jshint', function(t){
  t.plan(3);
  var jshint_proc = child_process.fork('../node_modules/eslint/bin/eslint.js', ['fixtures/jshint_parity.js'], {silent: false});
  var jsxhint_proc = child_process.fork('../cli', ['fixtures/jshint_parity.js'], {silent: true});
  console.log(jshint_proc);
